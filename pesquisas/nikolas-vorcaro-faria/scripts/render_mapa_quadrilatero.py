...
V="#7a1f14"; V2="#8a4a12"; TP="#2f5d7c"; ORG="#b0730a"; KAL="#5b3f8c"
...
foto(fN,-43.55,-20.80,zoom=0.26); lab2("NIKOLAS FERREIRA","TOPÁZIO IMPERIAL, a lavra do áudio, embargada\nà venda pela GMAIS (acusada na Operação Rejeito) por meio de\nThiago Rodrigues de Faria, advogado, secretário parlamentar\ne amigo de Nikolas. Ferro, manganês e topázio",(-43.63,-20.42),(-43.44,-20.80),NN,TP,fs=11,lw=1.4,target=(-43.55,-20.76))
ax.plot(-43.715,-20.394,"s",ms=14,color="#c8752a",mec="white",mew=0.8,zorder=8); ax.plot(-43.52,-20.445,"s",ms=14,color="#b8261a",mec="white",mew=0.8,zorder=8)
blob(-43.715,-20.394,0.09,0.065,V2,0.22); blob(-43.52,-20.445,0.09,0.065,V,0.22)
foto(fV,-44.47,-20.70); lab2("DANIEL VORCARO","3D MINERALS 1: Vorcaro emprestou R$ 152,9 milhões\ne ficou com metade das cotas em garantia\nferro, a 4,5 km da Topázio",(-43.715,-20.394),(-44.36,-20.70),NV,V2,fs=10,target=(-44.47,-20.66))
foto(fV,-43.27,-20.56); lab2("DANIEL VORCARO","3D MINERALS 2: Vorcaro emprestou R$ 152,9 milhões\ne ficou com metade das cotas em garantia\nferro, a 7 km da Topázio",(-43.52,-20.445),(-43.16,-20.56),NV,V,fs=10,target=(-43.27,-20.52))
...
lab("PATRIMÔNIO MINERAÇÃO e HG MINERAÇÃO\nmineradoras do grupo de João Alberto Lages\n(preso na Operação Rejeito), Serra do Botafogo, a 5 e 7 km\nlicença comprada com R$ 500 mil de propina em fev/2025 (PF).\nO diretor da HG doou R$ 20 mil a Nikolas em 2022\ne foi indiciado por organização criminosa em 2026",(-43.585,-20.375),(-43.32,-20.10),color=ORG,fs=10.5,bold=True,lw=1.4)
...
ax.plot([],[],"s",color="#c8752a",ms=10,label="3D Minerals 1: financiada pelo Master de Vorcaro (metade em garantia)"); ax.plot([],[],"s",color="#b8261a",ms=10,label="3D Minerals 2: financiada pelo Master de Vorcaro (metade em garantia)"); ax.plot([],[],"D",color=V,ms=10,label="Tamisa e Itaminas: controladas ou compradas por Vorcaro"); ax.plot([],[],"P",color=ORG,ms=11,label="Patrimônio e HG: grupo de Lages, presos na Operação Rejeito"); ax.plot([],[],"h",color=KAL,ms=11,label="Empabra: de Lucas Kallas, sócio de Vorcaro na Biomm"); ax.plot([],[],"*",ms=18,color="#1f6fb2",label="Topázio Imperial: a lavra do áudio de Nikolas, à venda pela Gmais")
...
ax.legend(loc="upper right",bbox_to_anchor=(0.995,0.82),fontsize=10,frameon=True,facecolor="#faf6f0",edgecolor="#b0b0b0")
