...
C={"Belo Horizonte":((-43.94,-19.92),(-44.20,-19.62),True),"Nova Lima":((-43.85,-19.99),(-44.28,-19.80),False),"Sarzedo":((-44.14,-20.04),(-44.48,-20.22),False),"Ouro Preto":((-43.50,-20.39),(-43.08,-20.30),True)}
...
blob(-43.63,-20.42,0.11,0.085,TP,0.25); ax.plot(-43.63,-20.42,"*",ms=30,color=TP,mec="white",mew=1.2,zorder=9)
lab("TOPÁZIO IMPERIAL\na lavra do áudio de Nikolas Ferreira\nferro, manganês e topázio. Embargada",(-43.63,-20.42),(-43.55,-20.77),color=TP,fs=12,bold=True,ha="left",lw=1.3); foto(fN,-43.66,-20.77)
for lo,la in [(-43.715,-20.394),(-43.52,-20.445)]: ax.plot(lo,la,"s",ms=11,color=V,mec="white",mew=0.8,zorder=8)
blob(-43.715,-20.394,0.09,0.065,V,0.22); blob(-43.52,-20.445,0.09,0.065,V,0.22)
lab("3D MINERALS\nVorcaro emprestou R$ 152,9 milhões a ela\ne ficou com metade das cotas em garantia\nferro, a 4,5 km da Topázio",(-43.715,-20.394),(-44.36,-20.70),color=V,fs=10.5,bold=True,lw=1.4); foto(fV,-44.47,-20.70)
lab("3D MINERALS\nVorcaro emprestou R$ 152,9 milhões a ela\ne ficou com metade das cotas em garantia\nferro, a 7 km da Topázio",(-43.52,-20.445),(-43.16,-20.64),color=V,fs=10.5,bold=True,lw=1.4); foto(fV,-43.27,-20.64)
blob(-43.90,-19.98,0.10,0.075,V,0.2); ax.plot(-43.90,-19.98,"D",ms=15,color=V,mec="white",mew=1.2,zorder=9)
lab("TAMISA\ncontrolada por fundo do Master (93% das ações)\nSerra do Curral, ao lado das minas de Lages\n(Fleurs e Gute) e da Empabra (Kallas)",(-43.90,-19.98),(-43.58,-19.50),color=V,fs=10.5,bold=True,lw=1.4); foto(fV,-43.69,-19.50)
blob(-44.12,-20.05,0.10,0.075,V,0.2); ax.plot(-44.12,-20.05,"D",ms=15,color=V,mec="white",mew=1.2,zorder=9)
lab("ITAMINAS\nVorcaro comprou metade\nem 2024, com AVG e Ageo",(-44.12,-20.05),(-44.38,-19.98),color=V,fs=10.5,bold=True,lw=1.4); foto(fV,-44.48,-19.98)
...
lab("EMPABRA, de Lucas Kallas\nKallas é sócio de Vorcaro\nem outra empresa (Biomm)\nbauxita, a 8 km da Topázio",(-43.6899,-20.4662),(-44.38,-20.34),color=KAL,fs=10.5,bold=True,lw=1.4); foto(fV,-44.47,-20.34,zoom=0.17)
