...
ax.plot([],[],"s",color="#c8752a",ms=9,label="3D Minerals 1 (financiada pelo Master)"); ax.plot([],[],"s",color="#b8261a",ms=9,label="3D Minerals 2 (financiada pelo Master)"); ax.plot([],[],"D",color=V,ms=9,label="Controladas ou compradas por Vorcaro"); ax.plot([],[],"P",color=ORG,ms=10,label="Grupo de Lages (presos na Rejeito)"); ax.plot([],[],"h",color=KAL,ms=10,label="Empabra (Kallas)"); ax.plot([],[],"*",ms=16,color=TP,label="Lavra da Topázio (Nikolas e Faria)")
